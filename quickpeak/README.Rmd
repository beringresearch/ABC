...
To streamline exploration, **quickpeak** is also accessible through a shiny dashboard. This functionality is triggered by running __qpeak__ without specifying the __feature__ argument.
