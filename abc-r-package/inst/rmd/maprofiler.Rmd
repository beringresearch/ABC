...
```{r ma-volcanoplot, fig.cap="Volcano plot of all differentially expressed genes (adjusted p-value < 0.05). Top 10 differentially expressed genes are labeled.", fig.width=6, fig.height=6, echo = FALSE, warning=FALSE, message=FALSE}
